...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // TODO
        springClaases.stream()
                .filter(oc -> !oc.isClosed())   // oc클래스 instance를 return
                .forEach(oc -> System.out.println(oc.getId()));
        // 메소드 레퍼런스
        springClaases.stream()
        ...
        // TODO
        springClaases.stream()
                .map(oc -> oc.getTitle())   // string을 return
        ...
        // TODO
        List<String> spring = springClaases.stream().
                filter(oc -> oc.getTitle().contains("spring"))
                .map(oc -> oc.getTitle())
                .collect(Collectors.toList());

        // Operators의 순서에 따라 다음 operator가 받는 parameter가 변할 수 있으므로 주의!
